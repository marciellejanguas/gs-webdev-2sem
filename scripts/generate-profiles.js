...
const cidades = ["São Paulo/SP","Rio de Janeiro/RJ","Belo Horizonte/MG","Porto Alegre/RS","Curitiba/PR","Recife/PE","Salvador/BA","Fortaleza/CE"];
const skills = ["React","Node.js","TypeScript","Python","SQL","Figma","Docker","AWS","Git","HTML","CSS","Jest","Express","Next.js","Tailwind"];
const resumoBase = "Profissional com experiência em projetos de tecnologia, foco em colaboração e entrega de valor.";
